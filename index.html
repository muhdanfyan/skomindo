...
<head>
    ...
    <!-- Site Metas -->
    <title>CV. Sarjana Komputer Indonesia - Lembaga Pengembangan Mahasiswa IT dan Sarjana Komputer</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        ...
                                        <h4>Program ini dirancang khusus bagi mahasiswa IT yang ingin memiliki skill di bidang IT, seperti web dan android programming, graphic designer, internet marketing, dan masih banyak lagi.</h4>
                                        <br>
	...
	<!-- end section -->
	<!-- section -->
    <div class="section contact_section" style="background:#312E5F;">
        <div class="container">
               <div class="row">
                 <div class="col-lg-6 col-md-6 col-sm-12">
				    <div class="full float-right_img">
    ...
    <script async src="https://whatsform.com/launcher.js" id="wf-widget" data-id="CeGUuy" data-message="Hubungi Kami Di Whatsapp" ></script>
	<script>
	/* counter js */
